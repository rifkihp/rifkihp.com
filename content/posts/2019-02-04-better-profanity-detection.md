...
img: "https://rifkihp.com/media/xkcd-290.png"
isML: true
...
I ended up building and releasing my own library for this purpose called [profanity-check](https://github.com/rifkihp/profanity-check).
...
Now armed with a cleaned, combined dataset (which you can [download here](https://github.com/rifkihp/profanity-check/blob/master/profanity_check/data/clean_data.csv)), I was ready to train the model!
