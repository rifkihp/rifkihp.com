...
In this post, we'll take a look at the Node.js backend powering our [example .io game](https://example-io-game.rifkihp.com):
...
All of the code for our example .io game is open-source on [Github](https://github.com/rifkihp/example-.io-game). Have questions or concerns? Leave a comment below or [tweet at me](https://twitter.com/victorczhou).
