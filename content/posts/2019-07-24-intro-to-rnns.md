...
img: "https://rifkihp.com/media/rnn-post/bptt.png"
isML: true
...
Here are a few samples from the small [dataset](https://github.com/rifkihp/rnn-from-scratch/blob/master/data.py) I put together for this post:
...
The [dataset](https://github.com/rifkihp/rnn-from-scratch/blob/master/data.py) I mentioned earlier consists of two Python dictionaries:
...
**Want to try or tinker with this code yourself? [Run this RNN in your browser](https://repl.it/@rifkihp/A-RNN-from-scratch).** It's also available on [Github](https://github.com/rifkihp/rnn-from-scratch).
