...
img: "https://rifkihp.com/media/io-game-post/screenshot.png"
isWeb: true
...
To help us learn, we're going to be referencing the [example .io game](https://example-io-game.rifkihp.com) embedded below. Go ahead, try it out! **You can play it right here on this page:**
...
<div id="example-io-game">
    <iframe title="An example .io game" src="https://example-io-game.rifkihp.com" width="100%" height="700px" loading="lazy"></iframe>
</div>
<figcaption>On mobile, it works best fullscreen at <a href="https://example-io-game.rifkihp.com" target="_blank" rel="noopener noreferrer">https://example-io-game.rifkihp.com</a></figcaption>
...
> I recommend [**downloading the source code**](https://github.com/rifkihp/example-.io-game) for the example game so you can follow along.
...
```bash
$ git clone https://github.com/rifkihp/example-.io-game.git
$ cd example-.io-game
$ npm install
```
...
```
<figcaption>This code sample is slightly abridged for clarity, as many code samples in this post will be. You can always see the full code on <a href="https://github.com/rifkihp/example-.io-game" target="_blank" rel="noopener noreferrer">Github</a>.</figcaption>
...
> Read the rest of [src/client/render.js](https://github.com/rifkihp/example-.io-game/blob/master/src/client/render.js) if you're interested in seeing the other render helper functions.
...
All that's left in `state.js` is the implementation of linear interpolation, which is just some simple (but boring) math. If you want to see it for yourself, look at `state.js` on [Github](https://github.com/rifkihp/example-.io-game/blob/master/src/client/state.js).
...
Have questions? Leave a comment below or [tweet at me](https://twitter.com/victorczhou). Found a bug or spot a problem in my code? Submit an issue or PR to the [example-.io-game Github repo](https://github.com/rifkihp/example-.io-game).
