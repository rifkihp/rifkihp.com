...
img: "https://rifkihp.com/media/cnn-post/cnn-dims-3.png"
isML: true
...
**Want to try or tinker with this code yourself? [Run this CNN in your browser](https://repl.it/@rifkihp/A-CNN-from-scratch-Part-1).** It's also available on [Github](https://github.com/rifkihp/cnn-from-scratch/tree/forward-only).
