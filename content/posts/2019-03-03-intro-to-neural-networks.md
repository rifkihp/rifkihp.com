...
img: "https://rifkihp.com/media/neural-network-post/network3.png"
isML: true
...
> You can [**run / play with this code yourself**](https://repl.it/@rifkihp/An-Introduction-to-Neural-Networks). It's also available on [Github](https://github.com/rifkihp/neural-network-from-scratch).
