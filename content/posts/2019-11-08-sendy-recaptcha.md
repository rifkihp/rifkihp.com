...
img: "https://rifkihp.com/media/sendy-recaptcha/recaptcha.png"
isWeb: true
category: "Security"
tags:
  - "Security"
...
I did some further investigation into Sendy's [standard subscribe form](https://sendy.rifkihp.com/subscription?f=K892tNsoSJBXB56YBbPUmxU74VxOqJ5DMbMZ6wxMWPQ4X6amCgnApdNbY763h0onBKMcQ751ge1VN7MtbBR11Hu7zA) in an attempt to understand what Ben meant. Here's an abbreviated version of the HTML behind that form:

```html
<form action="https://sendy.rifkihp.com/subscribe" method="POST">
  <div>
...
The first thing I noticed was the value of the form's `action` attribute: https://sendy.rifkihp.com/subscribe. Interestingly enough, that's the exact URL where the official [Sendy API](https://sendy.co/api) lives.
...
for (let i = 0; i < 100; i++) {
  request.post('https://sendy.rifkihp.com/subscribe').form({
    email: `sendy-vulnerability-${i}@rifkihp.com`,
