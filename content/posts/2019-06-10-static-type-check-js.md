...
To put the cherry on top, Flow is also super easy to setup in an existing codebase. I'll prove it to you: we'll integrate Flow with my open-source [example-io-game](https://github.com/rifkihp/example-.io-game) codebase (from my [building an .io web game](/blog/build-an-io-game-part-1/) series) right now!

### Setting up Flow for a Website

If you want to follow along, [download the code](https://github.com/rifkihp/example-.io-game) first. If you're curious, you can also check out a [live demo](https://example-io-game.rifkihp.com/) of the code.
...
- An example Flow implementation: [rifkihp.com](https://github.com/rifkihp/rifkihp.com) (yes, this blog!).
- Another example: [example-io-game](https://github.com/rifkihp/example-.io-game/tree/flow), our example from this post.
